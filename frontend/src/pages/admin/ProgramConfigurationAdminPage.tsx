  ...
  return (
    <div className="space-y-5 p-6">
      <PageHeader
        ...
        subtitle="Reusable product names for guidelines, AI rule setup, quotes, policies, and reporting"
      />
          ...
          <div className="overflow-auto">
            <table className="sd-table">
              ...
              <tbody>
                ...
                {programs.length === 0 && (
                  <tr>
                    <td colSpan={4} className="py-8 text-center" style={{ color: 'var(--ink-4)' }}>No programs configured yet.</td>
                  </tr>
                )}
              </tbody>
            </table>
