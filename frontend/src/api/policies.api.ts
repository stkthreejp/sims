...
export const policiesApi = {
  ...
  markForNonRenewal: (id: string, data: MarkNonRenewal) =>
    apiClient.post<PolicyTransaction>(`/policies/${id}/non-renew/mark`, data).then((r) => r.data),
