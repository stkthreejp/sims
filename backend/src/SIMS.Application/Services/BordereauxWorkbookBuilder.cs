...
internal static class BordereauxWorkbookBuilder
{
        ...
        IReadOnlyList<object?> sheetSpecificValues)
    {
        var values = new List<object?>
        {
            null,
            row.StateOfFiling,
            row.SurplusLinesBrokerName,
            row.SurplusLinesBrokerLicenseNumber,
            row.NewJerseySlaNumber,
            row.SurplusLinesBrokerAddress,
            row.SurplusLinesBrokerState,
            row.SurplusLinesBrokerZipCode,
...
internal sealed record BordereauxLondonPremiumRow(
    ...
    string SurplusLinesBrokerName,
    string SurplusLinesBrokerLicenseNumber,
    string? NewJerseySlaNumber,
    string SurplusLinesBrokerAddress,
