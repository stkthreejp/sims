...
{
    public partial class Rating_IM_Reseed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    -- Factor Table: DEDUCTIBLE_FACTOR
        ...
        {
            migrationBuilder.Sql(@"
                DELETE FROM carrier_rating_assignments WHERE rating_plan_version_id IN (
